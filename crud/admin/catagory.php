...
<div>
<form action="catagory.php" method="POST" enctype="multipart/form-data">
...
<input type="submit" class="searchBtn" name="submit" value="submit"></form><br>
    <table>
    <tr>
    <td colspan="5"><a class="a3" href="addCatagory.php">Add</a></td>
</tr>
...
if(isset($_POST['submit'])){
    ...
    $sql6="SELECT * FROM catagory WHERE catagory_name LIKE '$search%';";
    $result6=$con->query($sql6);
    if($result6->num_rows>0){
        while($row6=$result6->fetch_assoc()){
    ?>        
           <tr>
            <td><?php echo $row6['catagory_id']; ?></td>
            <td><?php echo $row6['catagory_name']; ?></td>
            <td><a href="editCatagory.php?cid=<?php echo $row6['catagory_id']; ?>">Edit</a></td>
            <td><a class="a2" href="deleteCatagory.php?cid=<?php echo $row6['catagory_id']; ?>">Delete</a></td>
        </tr>
<?php
        }
    }
...
?>
        ...
        <tr>
            ...
            <td><a href="editCatagory.php?cid=<?php echo $row['catagory_id']; ?>">Edit</a></td>
            <td><a class="a2" href="deleteCatagory.php?cid=<?php echo $row['catagory_id']; ?>">Delete</a></td>
        </tr>
